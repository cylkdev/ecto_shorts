defmodule EctoShorts.CommonFilters.QuerySourceProvider do
  @moduledoc false

  alias EctoShorts.Config
  alias EctoShorts.CommonFilters.QuerySourceProvider.Common

  @doc false
  def resolve_expression(binding_selector, expression_key, expression_params, opts \\ []) do
    query_source_provider =
      Keyword.get(opts, :query_source_provider, Config.query_source_provider()) || Common
