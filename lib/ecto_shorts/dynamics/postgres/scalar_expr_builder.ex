defmodule EctoShorts.Dynamics.Postgres.ScalarExprBuilder do
  ...
  def quote_negated_expr(op, q_var, {key_var, {quantifier, value_var}})
      when op in @equality_directives and quantifier in @quantifier_directives do
    op
  ...
  defp value_expr_ast(q_var, {:field, field_name}) when is_atom(field_name) do
    quote do
