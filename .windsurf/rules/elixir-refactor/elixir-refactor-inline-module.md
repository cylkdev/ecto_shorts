...
description: A small module is only referenced by one owning module and has no independent public contract. Its functions are tightly coupled to the owner's data shape/workflow. Keeping it separate adds cross-module jumps without reuse.
---
