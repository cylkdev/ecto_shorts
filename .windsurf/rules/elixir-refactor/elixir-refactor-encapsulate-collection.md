...
description: Callers directly mutate list/map fields via %{struct | items: ...}, Map.update!/3, put_in/2, or ++/--. Invariants (uniq, sorted, filtered) are enforced ad hoc with Enum.uniq/sort at call sites. Add/remove functions should own the collection rules.
---
