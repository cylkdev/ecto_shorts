...
description: One function coordinates many intermediate bindings reused across steps, and extracting helpers would require passing many arguments. You see 3+ derived locals and multiple step groups sharing them. Move the operation into a dedicated module/struct that carries state through small functions.
---
