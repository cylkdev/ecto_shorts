...
description: Helper functions are declared public (def) but are only called inside the same module. The function is undocumented or marked @doc false and is not intended as part of the API. Converting to defp shrinks the public surface and prevents external coupling.
---
