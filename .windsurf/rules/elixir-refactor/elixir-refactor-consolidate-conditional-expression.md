...
description: Multiple separate if/case checks return the same consequence (same {:error, reason} or same value). You see nested conditionals where each branch repeats an identical outcome. Conditions can be combined into one predicate function used once.
---
