...
description: A function rebinds a parameter name inside the body (param = ...; param = ...). Later expressions depend on which version of the name is in scope. Introduce new bindings for transformed values to keep the original input meaning.
---
