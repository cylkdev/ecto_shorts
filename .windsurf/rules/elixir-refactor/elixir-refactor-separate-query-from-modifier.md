...
description: A function both updates data and returns a computed answer (returns {flag, updated_struct} or mixes side effects with a query). Callers depend on both return value and mutation semantics. Split into a pure predicate/query function and a separate modifier function.
---
