...
description: A parameter (boolean/atom) acts as a control flag selecting fundamentally different behaviour. Callers pass true/false or :premium/:standard and intent is hidden. Split into separate named functions per variant and remove the selector arg.
---
