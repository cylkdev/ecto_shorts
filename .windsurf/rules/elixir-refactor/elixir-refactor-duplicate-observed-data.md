...
description: The same domain data exists in two places (e.g., socket.assigns plus a domain struct/map) and is copied back and forth. Event handlers/controllers update one representation and then manually assign/merge the other. Stale UI/state bugs appear because synchronization rules are scattered.
---
