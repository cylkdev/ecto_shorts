...
description: A local binding is assigned once and used once as a direct substitution (x = expr; ... x ...). The expression is pure/cheap and the name adds no domain meaning. Inlining removes a useless temporary without changing behaviour.
---
