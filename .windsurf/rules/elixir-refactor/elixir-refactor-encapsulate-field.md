...
description: External modules read/write struct fields directly (user.status, %{user | status: ...}) instead of going through API functions. Normalization/validation is duplicated at call sites. Changing the field representation would require widespread edits.
---
