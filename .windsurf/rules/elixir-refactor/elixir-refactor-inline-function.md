...
description: A function body is one expression/simple if/case and is called from one or very few places. It only delegates (def foo(a), do: Bar.foo(a)) or returns a field/literal. The extra call boundary adds indirection without meaning.
---
