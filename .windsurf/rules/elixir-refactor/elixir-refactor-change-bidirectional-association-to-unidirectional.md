...
description: Schemas model both sides of a relationship (has_many + belongs_to / mirrored *_ids) but only one direction is used. Code performs extra writes/changeset steps to keep reverse links consistent. Reverse links cause stale-data bugs or maintenance churn.
---
