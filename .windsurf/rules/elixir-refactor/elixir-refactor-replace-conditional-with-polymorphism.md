...
description: Multiple functions repeat case/cond branching on a kind/type atom to choose behaviour. Adding a new variant requires editing several branching sites. Move variant behaviour into modules/protocols behind a shared callback contract.
---
