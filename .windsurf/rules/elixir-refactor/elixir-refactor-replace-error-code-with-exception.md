...
description: Code encodes exceptional failures as sentinel return codes/atoms and deep callers branch on them repeatedly. Functions return {:error, reason} for what should be a crash/raise in truly impossible states. Introduce bang APIs (foo!/1) that raise with clear messages for exceptional paths.
---
