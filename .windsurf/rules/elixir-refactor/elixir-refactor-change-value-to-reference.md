...
description: Multiple structs/schemas duplicate the same mutable entity fields (name/email/address) instead of referencing one canonical record. Updates require touching many records and values drift out of sync. You see copy/pasted validations and sync code across modules.
---
