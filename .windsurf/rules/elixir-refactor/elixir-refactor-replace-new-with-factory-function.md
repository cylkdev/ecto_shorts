...
description: Call sites construct structs directly with %Struct{} or struct/2 and duplicate defaults/validation. Multiple creation modes are scattered and inconsistent. Introduce factory functions (new/..., named constructors) and route callers through them.
---
