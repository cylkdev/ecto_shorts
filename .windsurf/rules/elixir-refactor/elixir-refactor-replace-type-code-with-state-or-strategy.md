...
description: Many call sites select algorithms based on runtime state/policy using case/cond on a strategy value. Adding a new strategy requires editing dispatch code in several places. Introduce behaviour-driven strategy/state modules and inject/select the module at runtime.
---
