...
description: A struct/schema stores a *_id and code repeatedly loads the referenced record (Repo.get/2, preload) just to read snapshot-like attributes. Historical records should keep old values even if the referenced entity changes. Reads are slowed/complicated by unnecessary joins/lookups.
---
