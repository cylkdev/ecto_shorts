...
description: External library types are used directly across many modules and app-specific helpers are duplicated (Decimal.compare, DateTime formatting, Ecto.UUID casts). You want a stable local API that centralizes those rules. A wrapper module/struct can own domain semantics and delegate to the library.
---
