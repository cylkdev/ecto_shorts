...
description: A single expression/pipeline mixes access, transformation, and decision (nested calls, long boolean, deep |> chain). The same sub-expression is repeated or hard to debug. Binding part of the expression to a name would make intent explicit.
---
