...
description: Call sites reach through nested structs/maps via order.customer.address.city or get_in/2 chains. Many modules know the internal shape of another domain. Boundary functions (Order.shipping_city/1) would remove message-chain coupling.
---
