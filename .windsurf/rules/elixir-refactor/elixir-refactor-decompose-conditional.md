...
description: One if/case mixes a long boolean condition (multiple calls, comparisons, and/or) with multi-step branch bodies. The intent is unclear without comments. Extracting a predicate and named branch helpers would make the decision readable.
---
