...
description: A general struct contains many fields that are nil for most variants and only used by specific kinds. Pattern matches and validations branch on kind plus presence of specialized fields. Split variant-specific fields into variant structs to reduce irrelevant data.
---
