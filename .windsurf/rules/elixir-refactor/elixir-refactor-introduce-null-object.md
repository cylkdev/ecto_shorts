...
description: Call sites guard a collaborator with nil checks (if notifier, do: notifier.send(...); case mod do nil -> ...). A missing collaborator should behave as a no-op/default. Provide a module implementing the behaviour with neutral implementations.
---
