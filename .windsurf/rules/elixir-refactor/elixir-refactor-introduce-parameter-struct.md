...
description: Functions have long positional argument lists (4+ params) where several args travel together. Call sites pass many sibling values/literals and ordering mistakes are easy. A struct/map parameter can group, validate, and default the set.
---
