...
description: Raw primitives (string/integer/map) carry domain meaning and require repeated validation/formatting logic (normalize_phone/1, parse_*). The same rules are copy/pasted across modules. Introduce a struct with a constructor that enforces invariants once.
---
