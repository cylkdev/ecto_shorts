...
description: One module contains several unrelated function clusters (pricing, rendering, IO, persistence) that change for different reasons. The file keeps growing with mixed helpers and policies. Splitting into cohesive modules/submodules would reduce churn and coupling.
---
