...
description: Manual recursion or Enum.reduce_while/3 with lots of branching implements a standard operation (find, filter, membership) in a hard-to-read way. Complex cond/case logic disappears if replaced with Enum/Map/MapSet primitives. Lock behaviour down with input/output tests while swapping algorithms.
---
