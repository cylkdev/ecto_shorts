...
description: Multiple modules implement the same function names/arity and are passed around as interchangeable strategy modules. Dispatch happens via a module variable (strategy_module.quote(order)) but there is no @callback/@behaviour contract. Missing callbacks fail at runtime instead of at compile time.
---
