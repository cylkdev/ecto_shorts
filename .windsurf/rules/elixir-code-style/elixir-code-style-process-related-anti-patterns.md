...
description: Code introduces or interacts with processes (GenServer/Agent/Task/spawn, send/receive). Smells include processes used only for code organization, scattered direct Agent/GenServer calls across modules, spawning tasks that capture large terms, or long-running processes started outside supervision.
---
