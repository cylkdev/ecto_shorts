...
description: Code shows readability/maintainability smells: line-by-line comments repeating the code, with ... else blocks that merge unrelated error shapes, a single function returning different shapes based on opts, or many boolean flags at call sites (enabled?, premium?, admin?).
---
