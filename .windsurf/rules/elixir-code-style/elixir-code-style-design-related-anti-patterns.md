...
description: Public APIs encode meaning in options/flags (return shape controlled by opts like return: ..., mutually exclusive states modeled as many booleans). Call sites pass true/false or :mode atoms that hide intent. Prefer explicit functions and richer domain types.
---
