...
description: Code defines modules/functions/variables and should follow naming cues: snake_case locals, CamelCase modules, _ignored vars, foo? predicates, foo! raising variants, and is_ prefixes reserved for guard-friendly predicates. Filenames mirror module names.
---
