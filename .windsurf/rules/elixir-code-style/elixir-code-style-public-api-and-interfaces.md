...
description: Public APIs hide required inputs inside maps/opts and then extract keys in the body (params[:id], params[:email]). Too-large public surfaces expose internal helpers as def instead of defp. Prefer explicit positional args for required data and clear boundary modules/interfaces.
---
