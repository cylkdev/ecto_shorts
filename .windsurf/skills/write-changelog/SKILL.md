...
- **Added** - new function, parameter, option, type, or behavior callback.
- **Changed** - altered return value, parameter meaning, default value, or observable behavior of an existing function.
