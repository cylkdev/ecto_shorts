...
description: Run when reviewing the architecture of a project
---
...
- Write the ArchitectureReview document to a file at the root of the project in the format: `<YYYY>-<MM>-<DD>-architecture_review.md`. Write the file in chunks as the document will grow over time.
