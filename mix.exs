  ...
  defp docs do
    [
      ...
      groups_for_docs: [
        ...
        group_for_function("Schema Reflection API"),
      ...
      groups_for_modules: [
        ...
        "Query API": [
          ...
          EctoShorts.DynamicExpression.Postgres,
          EctoShorts.DynamicExpression.Postgres.Array,
          EctoShorts.DynamicExpression.Postgres.Field,
          EctoShorts.QueryHelpers,
