...
- **Extract Struct**: Create a struct to hold the related data.
- **Introduce Parameter Object**: Replace multiple parameters with a single struct.
- **Preserve Whole Object**: Pass the struct instead of extracting fields.
