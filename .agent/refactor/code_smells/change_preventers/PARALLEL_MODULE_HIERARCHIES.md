...
- Use protocol implementations when the repeated variation is type-specific.
- **Extract Behaviour**: Define contracts that modules implement inline.
- Group code by business concept instead of by technical layer.
