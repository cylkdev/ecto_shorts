...
Humans and coding agents should treat this document as a living document and always keep it up to date. It should always match the current working tree.
