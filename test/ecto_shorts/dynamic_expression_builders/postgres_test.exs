defmodule EctoShorts.DynamicExpressionBuilders.PostgresTest do
  use ExUnit.Case, async: true
  doctest EctoShorts.DynamicExpressionBuilders.Postgres

  alias EctoShorts.DynamicExpressionBuilders.Postgres
