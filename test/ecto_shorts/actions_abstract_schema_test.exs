defmodule EctoShorts.ActionsAbstractSchemaTest do
  ...
  describe "create: " do
    ...
    test "returns changeset error" do
      assert {:error, changeset} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{unique_identifier: "1"})
  ...
  describe "delete: " do
    test "deletes record by id" do
      ...
      assert {:ok, deleted_schema_data} =
               Actions.delete({"file_info_user_avatars", FileInfo}, schema_data.id)
  ...
  describe "all: " do
    test "returns records in ascending order by default" do
      assert {:ok, schema_data_1} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{name: "example.txt"})

      assert {:ok, schema_data_2} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{name: "example.txt"})
    ...
    test "returns records in descending order when option :order_by is set" do
      assert {:ok, schema_data_1} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{content_length: 1})

      assert {:ok, schema_data_2} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{content_length: 2})

      assert [^schema_data_2, ^schema_data_1] =
               Actions.all({"file_info_user_avatars", FileInfo}, %{},
                 order_by: {:desc, :content_length}
               )
    end
    ...
    test "returns records by map query parameters" do
      ...
      assert [^schema_data] =
               Actions.all({"file_info_user_avatars", FileInfo}, %{id: schema_data.id})
    end
  ...
  describe "find: " do
    test "returns record" do
      ...
      assert {:ok, ^schema_data} =
               Actions.find({"file_info_user_avatars", FileInfo}, %{id: schema_data.id})
    end
  ...
  describe "find_or_create: " do
    test "returns existing record" do
      ...
      assert {:ok, ^schema_data} =
               Actions.find_or_create({"file_info_user_avatars", FileInfo}, %{id: schema_data.id})
    end
  ...
  describe "update: " do
    test "updates existing record by data" do
      ...
      assert {:ok, updated_schema_data} =
               Actions.update({"file_info_user_avatars", FileInfo}, schema_data, %{
    ...
    test "updates existing record by ID" do
      ...
      assert {:ok, updated_schema_data} =
               Actions.update({"file_info_user_avatars", FileInfo}, schema_data.id, %{
                 name: "updated_name.txt"
               })
  ...
  describe "aggregate: " do
    ...
    test "returns expected value for aggregate sum" do
      ...
      assert 3 =
               Actions.aggregate({"file_info_user_avatars", FileInfo}, %{}, :sum, :content_length)
    end
    ...
    test "returns expected value for aggregate avg" do
      ...
      assert ^expected_decimal =
               Actions.aggregate({"file_info_user_avatars", FileInfo}, %{}, :avg, :content_length)
    end
    ...
    test "returns expected value for aggregate min" do
      ...
      assert {:ok, _} =
               Actions.create({"file_info_user_avatars", FileInfo}, %{content_length: 20})

      assert 1 =
               Actions.aggregate({"file_info_user_avatars", FileInfo}, %{}, :min, :content_length)
    end
    ...
    test "returns expected value for aggregate max" do
      ...
      assert 20 =
               Actions.aggregate({"file_info_user_avatars", FileInfo}, %{}, :max, :content_length)
    end
  end
  ...
  describe "find_or_create_many: " do
    test "returns existing record" do
      ...
      assert {:ok, [^schema_data]} =
               Actions.find_or_create_many({"file_info_user_avatars", FileInfo}, [
                 %{id: schema_data.id}
               ])
    end
