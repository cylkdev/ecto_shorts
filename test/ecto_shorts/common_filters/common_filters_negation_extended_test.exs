defmodule EctoShorts.CommonFilters.NegationExtendedTest do
  ...
  describe "convert_params_to_filter/3 negated aggregate nil checks" do
    test "excludes nil aggregate using not ==" do
      ...
      actual = CommonFilters.convert_params_to_filter(Post, %{views: %{not: %{avg: %{==: nil}}}}, [])
    ...
    test "negated aggregate != produces == check" do
      ...
      actual = CommonFilters.convert_params_to_filter(Post, %{views: %{not: %{avg: %{!=: 50}}}}, [])
