defmodule EctoShorts.CommonParamsTest do
  ...
  describe "convert_to_insert_params/3: " do
    test "updates the field updated_at by default" do
      assert {:ok,
              [
                %{
                  id: 1,
    ...
    test "when arg is map params and option validate is false, returns expected result" do
      assert {:ok,
              [
                %{
                  title: "post_1_title",
    ...
    test "when element is {changeset, params}, returns expected result"  do
      assert {:ok,
              [
                %{
                  title: "post_1_title",
                  unique_identifier: "post_1_unique_identifier",
                  inserted_at: post_1_inserted_at,
                  updated_at: post_1_updated_at
                } = post_1_params,
                %{
                  title: "post_2_title",
                  unique_identifier: "post_2_unique_identifier",
                  inserted_at: post_2_inserted_at,
                  updated_at: post_2_updated_at
                } = post_2_params
              ]
              ...
              CommonParams.convert_to_insert_params(
                ...
                [
                  {
                    Post.changeset(%Post{}, %{unique_identifier: "post_1_unique_identifier"}),
                    %{title: "post_1_title"}
                  },
                  {
                    Post.changeset(%Post{}, %{unique_identifier: "post_2_unique_identifier"}),
                    %{title: "post_2_title"}
                  }
                ],
                []
    ...
    test "when element is {changeset, map} and option validate is false, merges params onto changes then into struct" do
      assert {:ok,
              [
                %{
                  title: "post_1_title",
    ...
    test "when arg is map params, returns expected result" do
      assert {:ok,
              [
                %{
                  title: "post_1_title",
    ...
    test "when arg is map params and invalid, returns changeset errors" do
      assert {
        :error,
        [
          {
    ...
    test "when schema_data has non nil :id, timestamp inserted_at is not generated" do
      assert {:ok,
              [
                %{
                  id: 1,
    ...
    test "when schema_data has non nil :id and option validate is true, timestamp inserted_at is generated" do
      assert {:ok,
              [
                %{
                  title: "post_created_title",
      ...
      # id is not casted by a changeset and should not be here
      assert %{
        title: "post_created_title",
        inserted_at: inserted_at,
        updated_at: updated_at
    ...
    test "when schema_data has non nil :id and option validate is false, timestamp inserted_at is not generated" do
      assert {:ok,
              [
                %{
                  id: 1,
    ...
    test "when params has non nil :id, timestamp inserted_at is not replaced" do
      assert {:ok,
              [
                %{
                  id: 1,
    ...
    test "when schema_data :id has non nil value, timestamp inserted_at is not replaced " do
      assert {:ok,
              [
                %{
                  id: 1,
  ...
  describe "convert_to_update_params/3: " do
    test "when arg is map and params are valid returns expected result" do
      assert [
        inc: [views: 1],
    ...
    test "when arg is keyword and params are valid, returns expected result" do
      assert [
        inc: [views: 1],
        pull: [
          tags: "post_tag_old_1",
    ...
    test "when arg is map params and has a field that does not exist on the schema, log warning" do
      log =
