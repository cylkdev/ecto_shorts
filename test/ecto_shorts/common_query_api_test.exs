defmodule EctoShorts.CommonQueryLanguageTest do
  use ExUnit.Case, async: true
  doctest EctoShorts.CommonQueryLanguage

  alias EctoShorts.{
    CommonQueryBuilder.Macro,
    Schemas.Comment,
  ...
  describe "merge_dynamic/2" do
    test "merges a dynamic expression with another using AND when the first is nil" do
      ...
      assert_dynamic dyn,
                     CommonQueryBuilder.Macro.merge_dynamic(nil, :and, dynamic([q], q.id == ^1))
    end
    ...
    test "merges two dynamic expressions using AND" do
      ...
      assert_dynamic expected_dyn, CommonQueryBuilder.Macro.merge_dynamic(dyn_a, :and, dyn_b)
    end
    ...
    test "merges two dynamic expressions using OR" do
      ...
      dyn_a = dynamic([d], d.id == ^1)
      dyn_b = dynamic([d], d.published == true)
      assert_dynamic expected_dyn, CommonQueryBuilder.Macro.merge_dynamic(dyn_a, :or, dyn_b)
    end
  end
  ...
  describe "dynamic/1" do
    test "wraps a dynamic expression as is" do
      ...
      assert_dynamic dyn, CommonQueryBuilder.Macro.dynamic(nil, dynamic([d], d.id == ^1))
    end
  end
  ...
  describe "dynamic/4" do
    test "builds a dynamic expression using default Field comparison when no schema module is present" do
      ...
      assert_dynamic dyn, CommonQueryBuilder.Macro.dynamic(nil, "posts", tags: "example")
    end
    ...
    test "builds a dynamic expression using schema-based type when a schema module is present" do
      ...
      assert_dynamic dyn, CommonQueryBuilder.Macro.dynamic(nil, {"posts", Post}, tags: "example")
    end
  end
  ...
  describe "exclude/2" do
    test "excludes the given clause from the query" do
      ...
      assert_query expected_query, CommonQueryBuilder.Macro.exclude(base_query, :order_by)
    end
  end
  ...
  describe "from/3" do
    test "builds a query from a schema with a given alias and prefix" do
      ...
      assert_query query, CommonQueryBuilder.Macro.from(Post, :post, prefix: "example_prefix")
    end

    test "sets the query prefix using the query_prefix option" do
      assert %Ecto.Query{prefix: "example_prefix"} =
               CommonQueryBuilder.Macro.from(Post, :post, query_prefix: "example_prefix")
    end
  end
  ...
  describe "group_by/3" do
    test "adds a group_by clause to a query without an alias" do
      ...
      assert_query query, CommonQueryBuilder.Macro.group_by(Post, nil, :published)
    end
    ...
    test "adds a group_by clause to a query with an alias" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.group_by(base_query, :post, :published)
    end
  end
  ...
  describe "limit/3" do
    test "adds a limit to a query without an alias" do
      ...
      assert_query query, CommonQueryBuilder.Macro.limit(Post, nil, 5)
    end

    test "adds a limit to a query with an alias" do
      expected_query = from p in Post, as: :post, limit: ^5
      base_query = from p in Post, as: :post
      assert_query expected_query, CommonQueryBuilder.Macro.limit(base_query, :post, 5)
    end
    ...
    test "adds a limit to a join with an alias" do
      ...
      assert_query expected_query, CommonQueryBuilder.Macro.limit(base_query, :comments, 5)
    end
  end
  ...
  describe "offset/3" do
    test "adds an offset to a query without an alias" do
      ...
      assert_query query, CommonQueryBuilder.Macro.offset(Post, nil, 5)
    end

    test "adds an offset to a query with an alias" do
      expected_query = from p in Post, as: :post, offset: ^5
      base_query = from p in Post, as: :post
      assert_query expected_query, CommonQueryBuilder.Macro.offset(base_query, :post, 5)
    end
    ...
    test "adds an offset to a join with an alias" do
      ...
      base_query = from p in Post, join: c in Comment, as: :comments, on: c.post_id == p.id
      assert_query expected_query, CommonQueryBuilder.Macro.offset(base_query, :comments, 5)
    end
  end
  ...
  describe "order_by/3" do
    test "adds an order_by to a query without an alias" do
      ...
      assert_query query, CommonQueryBuilder.Macro.order_by(Post, nil, asc: :inserted_at)
    end
    ...
    test "adds an order_by to a query with an alias" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.order_by(base_query, :post, asc: :inserted_at)
    end
  end
  ...
  describe "join/6" do
    test "joins an association without aliasing" do
      ...
      assert_query query, CommonQueryBuilder.Macro.join(Post, :association, {nil, nil}, :comments)
    end
    ...
    test "joins an association with aliasing" do
      ...
      assert_query query,
                   CommonQueryBuilder.Macro.join(Post, :association, {nil, :comments}, :comments)
    end
    ...
    test "joins with dynamic ON expressions and schema detection fallback" do
      ...
      assert_query query,
                   CommonQueryBuilder.Macro.join(Comment, :association, {nil, :post}, :post, %{
                     on: %{tags: "example"}
                   })
    ...
    test "joins a subquery with left join and prefix, ON true" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.join(Post, :subquery, {nil, nil}, inner_query, %{
                     qualifier: :left,
                     prefix: "example_prefix"
                   })
    end
  ...
  describe "preload/2" do
    test "preloads associations without aliasing" do
      ...
      assert_query query, CommonQueryBuilder.Macro.preload(Post, nil, [:comments])
    end
  end
  ...
  describe "put_query_prefix/2" do
    test "updates the query prefix" do
      assert %Ecto.Query{prefix: "example_prefix"} =
               CommonQueryBuilder.Macro.put_query_prefix(Post, "example_prefix")
    end
  end
  ...
  describe "select/4" do
    test "selects the whole record when true" do
      ...
      assert_query query, CommonQueryBuilder.Macro.select(Post, nil, true)
    end

    test "selects specific fields as map" do
      query = from p in Post, select: map(p, [:id])
      assert_query query, CommonQueryBuilder.Macro.select(Post, nil, %{map: [:id]})
    end

    test "selects specific fields as struct" do
      query = from p in Post, select: struct(p, [:id])
      assert_query query, CommonQueryBuilder.Macro.select(Post, nil, %{struct: [:id]})
    end

    test "selects specific values directly" do
      query = from p in Post, select: [:id]
      assert_query query, CommonQueryBuilder.Macro.select(Post, nil, %{value: [:id]})
    end
  end
  ...
  describe "select_merge/4" do
    test "merges additional fields into a map selection" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.select_merge(base_query, nil, [:title])
    end
    ...
    test "merges additional map fields in a join" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.select_merge(base_query, :comments, %{map: [:replies]})
    end
    ...
    test "merges additional struct fields in a join" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.select_merge(base_query, :comments, %{
                     struct: [:replies]
                   })
    end
    ...
    test "merges select with true to keep the base selection" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.select_merge(base_query, :comments, true)
    end
    ...
    test "merges additional values into a direct value selection" do
      ...
      assert_query expected_query,
                   CommonQueryBuilder.Macro.select_merge(base_query, nil, %{value: [:title]})
    end
  end
  ...
  describe "or_where/3" do
    test "adds an OR filter with a basic integer equality" do
      ...
      assert_query query, CommonQueryBuilder.Macro.or_where(Post, nil, %{views: 1})
    end
    ...
    test "adds an OR filter using LIKE on a string field" do
      ...
      assert_query query,
                   CommonQueryBuilder.Macro.or_where(Post, nil, %{title: %{like: "example"}})
    end
    ...
    test "adds an OR filter with LIKE ANY array comparison" do
      ...
      assert_query query, CommonQueryBuilder.Macro.or_where(Post, nil, %{tags: %{like: "a"}})
    end

    test "adds an OR filter with ILIKE ANY array comparison" do
      query = from p in Post, or_where: fragment("? ILIKE ANY(?)", ^"%a%", p.tags)
      assert_query query, CommonQueryBuilder.Macro.or_where(Post, nil, %{tags: %{ilike: "a"}})
    end
  end
  ...
  describe "where/3" do
    test "adds a basic integer equality filter" do
      ...
      assert_query query, CommonQueryBuilder.Macro.where(Post, nil, %{views: 1})
    end
    ...
    test "adds a LIKE ANY array filter using fragment" do
      ...
      assert_query query, CommonQueryBuilder.Macro.where(Post, nil, %{tags: %{like: "a"}})
    end

    test "adds an ILIKE ANY array filter using fragment" do
      query = from p in Post, where: fragment("? ILIKE ANY(?)", ^"%a%", p.tags)
      assert_query query, CommonQueryBuilder.Macro.where(Post, nil, %{tags: %{ilike: "a"}})
    end
  end
end
