defmodule EctoShorts.Compiler.QueryBindingBuilderTest do
  ...
  test "get_query_binding_contracts/2 exposes root, named, and positional binding contracts" do
    {target_binding_var, binding_patterns} =
      EctoShorts.Compiler.get_query_binding_contracts(__MODULE__, max_binding_positions: 2)
