defmodule EctoShorts.TestQueryProvider do
  ...
  def resolve_query_expression(_selected_binding, :active_users, params, _opts) do
  ...
  def resolve_query_expression(_selected_binding, :for_update, _params, _opts) do
    {:ok, fn query -> from(q in query, lock: "FOR UPDATE") end}
  end

  def resolve_query_expression(_selected_binding, :for_share, _params, _opts) do
    {:ok, fn query -> from(q in query, lock: "FOR SHARE") end}
  end

  def resolve_query_expression(_selected_binding, :provider_for_update, _params, _opts) do
    {:ok, fn query -> from(q in query, lock: "FOR UPDATE") end}
  end

  def resolve_query_expression(_selected_binding, :for_update_with_clause, params, _opts) do
    params = normalize_params(params)
  ...
  def resolve_query_expression(_selected_binding, :post_window, _params, _opts) do
    {:ok, [partition_by: [:author_id], order_by: [desc: :inserted_at]]}
  end

  def resolve_query_expression(_selected_binding, :error_fragment, _params, _opts) do
    {:error, :forced_error}
  end

  def resolve_query_expression(_selected_binding, :legacy_active_users, params, _opts) do
    params = normalize_params(params)
  ...
  def resolve_query_expression(_selected_binding, :legacy_for_update, _params, _opts) do
