...
The simplest way to add custom filtering is to implement the `by_search/2` function in your schema module. This function is called by the `EctoShorts.CommonFilters.Common` module when you use the `:search` filter parameter in your queries.
