...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build/3`

## Comparison Operators

Comparison operators allow you to filter records based on field values using various comparison conditions. These are implemented in `EctoShorts.CommonFilters.Schema.ComparisonFilter`.
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:gt` operator
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:gte` operator
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:lt` operator
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:lte` operator
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build/3` which processes each comparison operator in the map
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:like` operator
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_schema_field_filters/5` with `:ilike` operator

## Date Filters

Date filters allow you to filter records based on their `inserted_at` timestamp. These filters are implemented in `EctoShorts.CommonFilters.Common`.
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:start_date` key
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:end_date` key
...
Pagination filters allow you to limit the number of records returned and implement cursor-based pagination. These filters are implemented in `EctoShorts.CommonFilters.Common`.
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:first` key
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:last` key
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:before` key
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:after` key

## Association Filters

Association filters allow you to filter records based on their relationships with other schemas. These are implemented in `EctoShorts.CommonFilters.Schema`.
...
**Implementation:** `EctoShorts.CommonFilters.Schema.create_schema_assocation_filter/5` and `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_relational/4`
...
**Implementation:** `EctoShorts.CommonFilters.Schema.create_schema_assocation_filter/5` and `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_relational_filter/5`

## Array Field Filters

Array field filters allow you to query PostgreSQL array fields. These are implemented in `EctoShorts.CommonFilters.Schema.ComparisonFilter`.
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_array/3` when passed a list
...
**Implementation:** `EctoShorts.CommonFilters.Schema.ComparisonFilter.build_array/3` when passed a single value

## Preloading

Preloading allows you to load associated data in a single query, reducing the N+1 query problem. This is implemented in `EctoShorts.CommonFilters.Common`.
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:preload` key
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:preload` key and a list value
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:preload` key and a keyword list value

## Custom Search

The custom search filter allows you to implement your own search logic in your schemas. This is implemented in `EctoShorts.CommonFilters.Common`.
...
**Implementation:** `EctoShorts.CommonFilters.Common.create_schema_filter/3` with `:search` key
