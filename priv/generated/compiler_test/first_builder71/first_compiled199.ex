defmodule EctoShorts.CompilerTest.FirstCompiled199 do
  @moduledoc """
  This module provides compiled positional binding functions for the EctoShorts.CompilerTest.FirstBuilder71 builder.
  """
