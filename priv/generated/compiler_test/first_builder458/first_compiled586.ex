defmodule EctoShorts.CompilerTest.FirstCompiled586 do
  @moduledoc """
  This module provides compiled positional binding functions for the EctoShorts.CompilerTest.FirstBuilder458 builder.
  """
