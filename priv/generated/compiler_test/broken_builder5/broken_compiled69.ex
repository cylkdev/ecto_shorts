defmodule EctoShorts.CompilerTest.BrokenCompiled69 do
  @moduledoc """
  This module provides compiled positional binding functions for the EctoShorts.CompilerTest.BrokenBuilder5 builder.
  """
