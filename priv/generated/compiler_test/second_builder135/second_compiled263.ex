defmodule EctoShorts.CompilerTest.SecondCompiled263 do
  @moduledoc """
  This module provides compiled positional binding functions for the EctoShorts.CompilerTest.SecondBuilder135 builder.
  """
